 ...
 * @author proxc
 */
public class cmd_pomp2 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cmd_pomp2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author proxc
 */
public class cmd_pomp4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Commande Pomp Haut Dersa Grand 2");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cmd_pomp4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
